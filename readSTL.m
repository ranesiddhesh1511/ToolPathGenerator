...
%      z1 = 0; %slicing palne
%      if (z1==Z(1,1)&& z1==Z(2,1)&& z1==Z(3,1))
%          {
%              
%              t=linspace(0,1);
%              a = X(1,1)+ t*(X(2,1)-X(1,1));
%              b = Y(1,1)+ t*(Y(2,1)-Y(1,1));
%              c = Z(1,1)+ t*(Z(2,1)-Z(1,1));
%              plot3(a,b,c);
%              hold on;
%              t=linspace(0,1);
%              a = X(1,1)+ t*(X(3,1)-X(1,1));
%              b = Y(1,1)+ t*(Y(3,1)-Y(1,1));
%              c = Z(1,1)+ t*(Z(3,1)-Z(1,1));
%              plot3(a,b,c);
%              hold on;
%              t=linspace(0,1);
%              a = X(2,1)+ t*(X(3,1)-X(2,1));
%              b = Y(2,1)+ t*(Y(3,1)-Y(2,1));
%              c = Z(2,1)+ t*(Z(3,1)-Z(2,1));
%              plot3(a,b,c);
%              hold on;
